...
class BigBlueButton {
    ...
    private function setCreateMeetingParam(): void {
        ...
        $this->createMeetingParam = new CreateMeetingParameters($this->meetingID, $this->welcomeString);
        $this->createMeetingParam->setModeratorPassword($this->modPW)
        
            ->setAttendeePassword($this->attPW)
            ->setWelcomeMessage($this->welcomeString)
